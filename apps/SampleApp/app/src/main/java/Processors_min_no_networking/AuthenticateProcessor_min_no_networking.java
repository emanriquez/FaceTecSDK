...
public class AuthenticateProcessor_min_no_networking implements FaceTecFaceScanProcessor {
    private SampleAppActivity sampleAppActivity;

    public AuthenticateProcessor_min_no_networking(final Context context, String sessionToken) {

        // Core FaceTec Device SDK code that starts the User Session.
        FaceTecSessionActivity.createAndLaunchSession(context, AuthenticateProcessor_min_no_networking.this, sessionToken);
    }
